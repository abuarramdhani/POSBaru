...
<section id="content">
				...
				<div class="card-body">
					...
					<div class="row">
						<div class="col-md-12" style="text-align: right;">
							<form action="<?=base_url()?>index.php/setting/deleteOutlet" method="post" onsubmit="return confirm('Do you want to delete this Outlet?')">
	...
	<form action="<?=base_url()?>index.php/setting/updateOutlet" method="post">				
					<div class="row">
						<div class="col-md-6">
