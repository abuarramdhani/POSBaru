						    	...
						    	<tbody>
									...
									<tr>
										...
										<td style="text-align:left; padding-left:1.5%; padding-bottom: 5px;">
											Discount&nbsp;<?php if (!empty($order_disPer)) {
                                                echo '('.$order_disPer.')';
                                            } ?>
										</td>
		...
		if(ele == "5"){
			...
			document.getElementById("cheque").required = false;
				...
				<?php
                    ...
                    if ($vt_status == '0') {
                        ?>
					<form action="<?=base_url()?>index.php/debit/submitDebitPayment" method="post">		
			...
			<a href="<?=base_url()?>index.php/debit/view" style="text-decoration: none;">
