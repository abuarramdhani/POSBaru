...
<section id="content">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"><?php echo $lang_payment_methods; ?></h1>
		</div>
	</div><!--/.row-->
					...
					<div class="row">
						<div class="col-md-12">
							<?php
                                if ($user_role < 3) {
                                    ?>
							<a href="<?=base_url()?>index.php/setting/addpaymentmethod" style="text-decoration: none">
								<button class="btn btn-primary" style="padding: 0px 12px;"><i class="icono-plus"></i>
									<?php echo $lang_add_payment_method; ?>
								</button>
							</a>
							<?php
                                    ...
                                    if (count($results) > 0) {
                                        foreach ($results as $data) {
                                            ...
                                            if ($status == '0') {
												...
												<td>
													<a href="<?=base_url()?>index.php/setting/editpaymentmethod?id=<?php echo $id; ?>" style="text-decoration: none; margin-left: 5px;">
