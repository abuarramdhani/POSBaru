				...
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-md-4" style="text-align: right;">
							<a href="<?=base_url()?>index.php/purchase_order/exportPurchaseOrder?id=<?php echo $id; ?>" style="text-decoration: none;" target="_blank">
							...
							<div class="form-group">
								...
								<?php
                                    ...
                                    for ($u = 0; $u < count($outletData); ++$u) {
										...
										<option value="<?php echo $outlet_id; ?>" <?php if ($po_outlet_id == $outlet_id) {
							...
							<div class="form-group">
								...
								<?php
                                    ...
                                    for ($s = 0; $s < count($supplierData); ++$s) {
										...
										<option value="<?php echo $supplier_id; ?>" <?php if ($po_supplier_id == $supplier_id) {
                                            echo 'selected="selected"';
                                        } ?>>
		...
		<?php
            ...
            for ($pi = 0; $pi < count($poItemData); ++$pi) {
				...
				<tr>
					...
					<td>
						<input type="text" name="existQty_<?php echo $po_item_id; ?>" class="form-control" value="<?php echo $po_item_qty; ?>" style="width: 50%;" <?php if ($po_status != '1') {
                    echo 'readonly';
                } ?> />
					</td>
					<td>
						<?php
                            if ($po_status == '1') {
                                ?>
						<a href="<?=base_url()?>index.php/purchase_order/deletePOItem?po_item_id=<?php echo $po_item_id; ?>&po_id=<?php echo $id; ?>" onclick="return confirm('Are you confirm to delete Purchase Order Item?')">
