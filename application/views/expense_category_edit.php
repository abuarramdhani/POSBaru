...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"><?php echo $lang_edit_expenses_category; ?> : <?php echo $exp_name; ?></h1>
		</div>
	</div><!--/.row-->
	
	<form action="<?=base_url()?>index.php/expenses/updateExpenseCategory" method="post">
	<div class="row">
		<div class="col-md-12">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="name" class="form-control" maxlength="499" autofocus required autocomplete="off" value="<?php echo $exp_name; ?>" />
							</div>
						</div>
			...
			<a href="<?=base_url()?>index.php/expenses/expense_category" style="text-decoration: none;">
