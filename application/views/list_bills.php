    ...
    if ($billRows > 0) {
        ...
        foreach ($billData as $data) {
			...
			<tr>
				...
				<td>
<a href="<?=base_url()?>index.php/pos?suspend_id=<?php echo $sus_id; ?>" style="text-decoration: none; cursor: pointer;" title="Bring to POS">
<i class="icono-list" style="color: #005b8a;"></i>
</a>
					
<a href="<?=base_url()?>index.php/sales/deleteSuspended?id=<?php echo $sus_id; ?>" style="text-decoration: none; margin-left: 5px;" title="Delete" onclick="return confirm('<?php echo $lang_confirm_to_delete_bill; ?>')">
