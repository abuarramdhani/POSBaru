		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<form action="<?=base_url()?>index.php/returnorder/return_report" method="get">
					<div class="row">
						<div class="col-md-3">
            ...
            $url_end = $end_yea.'-'.$end_mon.'-'.$end_day;
					...
					<div class="row" style="margin-top: 10px;">
						<div class="col-md-12" style="text-align: right;">
							<a href="<?=base_url()?>index.php/returnorder/exportReturnReport?report=<?php echo $_GET['report']; ?>&start_date=<?php echo $url_start; ?>&end_date=<?php echo $url_end; ?>&outlet=<?php echo $url_outlet; ?>&paid=<?php echo $url_paid_by; ?>" style="text-decoration: none">
    ...
    $total_sub_amt = 0;
        ...
        if ($orderRows > 0) {
			...
			<tr>
				...
				<td>
					<a href="<?=base_url()?>index.php/returnorder/confirmation?return_id=<?php echo $order_id; ?>" style="text-decoration: none;">
