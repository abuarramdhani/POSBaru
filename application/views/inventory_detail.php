<?php
    ...
    $data = $this->Constant_model->manualQerySelect("SELECT * FROM products WHERE id=$pcode");
    $data[0]['name'];
?>
...
<section id="content">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Persediaan Barang : <?php echo $data[0]['name'];; ?></h1>
		</div>
	</div><!--/.row-->
	...
	<div class="row">
		<div class="col-md-12">
			...
			<a href="<?=base_url()?>index.php/inventory/view" style="text-decoration: none;">
