			...
			<section class="scrollable wrapper">
				<div class="row">
					...
					<div class="wrapper font-bold">
					    ...
					    if ($user_role < 3) {
					    ?>
						<a href="<?=base_url()?>index.php/reports/sales_report" class="m-r"><i class=	"fa fa-calendar fa-2x icon-muted v-middle"></i> <?php echo $lang_reports; ?></a>
						<?php
						...
						<?php
					            if ($user_role == '1') {
					                ?>
						<a href="<?=base_url()?>index.php/setting/system_setting"  class="m-r"><i class="fa fa-gear fa-2x icon-muted v-middle"></i> <?php echo $lang_system_setting; ?></a>
							<?php
