					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="fullname" class="form-control"  maxlength="499" autofocus required autocomplete="off" value="<?php if (!empty($alert_msg)) {
                        echo $alert_msg[3];
                    } ?>" />
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="email" name="email" class="form-control" maxlength="254" required autocomplete="off" value="<?php if (!empty($alert_msg)) {
                        echo $alert_msg[4];
                    } ?>" />
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="password" name="password" class="form-control" maxlength="499" required autocomplete="off" value="<?php if (!empty($alert_msg)) {
                        echo $alert_msg[5];
                    } ?>" />
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="password" name="conpassword" class="form-control" maxlength="499" required autocomplete="off" value="<?php if (!empty($alert_msg)) {
                        echo $alert_msg[6];
                    } ?>" />
							</div>
						</div>
							...
							<div class="form-group" id="outlet_block">
								...
								<?php
                                    ...
                                    for ($u = 0; $u < count($outletData); ++$u) {
										...
										<option value="<?php echo $outlet_id; ?>" <?php if (!empty($alert_msg)) {
