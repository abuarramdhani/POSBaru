...
<section id="content">
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12" style="text-align: right;">
							<form action="<?=base_url()?>index.php/setting/deleteSupplier" method="post" onsubmit="return confirm('Do you want to delete this Suppler : <?php echo $supplier_name; ?>?')">
	...
	<form action="<?=base_url()?>index.php/setting/updateSupplier" method="post">				
					<div class="row">
						<div class="col-md-6">
