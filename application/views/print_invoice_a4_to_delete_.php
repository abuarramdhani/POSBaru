    ...
    <table border="0" style="border-collapse: collapse; width: 100%; height: auto;">
		...
		<tr>
			<td width="100%">
				...
				<span class="left" style="text-align: left;">Customer Phone : <?php if (empty($cust_mobile)) {
    echo '-';
} else {
    echo $cust_mobile;
} ?></span>
    ...
    <table class="totals" cellspacing="0" border="0" style="margin-bottom:5px; border-top: 1px solid #000; border-collapse: collapse;">
    	<tbody>
			...
			<tr>
				...
				<td style="text-align:left; padding-left:1.5%; padding-bottom: 5px;">Discount&nbsp;<?php if (!empty($dis_percentage)) {
                        echo '('.$dis_percentage.')';
                    } ?></td>
...
-->
    ...
    <div id="bkpos_wrp">
    	<a href="<?=base_url()?>index.php/pos" style="width:100%; display:block; font-size:12px; text-decoration: none; text-align:center; color:#FFF; background-color:#005b8a; border:0px solid #007FFF; padding: 10px 1px; margin: 5px auto 10px auto; font-weight:bold;">Back to POS</a>
    </div>
