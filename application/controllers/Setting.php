...
//      Lang Menu
    ...
    public function deletePaymentMethod()
    {
        ...
        if ($this->Constant_model->deleteData('payment_method', $pay_id)) {
            ...
            redirect(base_url().'index.php/setting/payment_methods');
        }
    }
    ...
    public function updateSupplier()
    {
        ...
        if (empty($name)) {
            ...
            redirect(base_url().'index.php/setting/editsupplier?id='.$id);
        } elseif (empty($tel)) {
    ...
    public function updatePaymentMethod()
    {
        ...
        if (empty($name)) {
            ...
            redirect(base_url().'index.php/setting/editpaymentmethod?id='.$id);
        } else {
            $upd_data = array(
                    'name' => $name,
                    'status' => $status,
    ...
    public function insertPaymentMethod()
    {
        ...
        if (empty($name)) {
            ...
            redirect(base_url().'index.php/setting/addpaymentmethod');
        } else {
            $ins_data = array(
                    'name' => $name,
                    'created_user_id' => $us_id,
    ...
    public function updatePassword()
    {
        ...
        if (empty($pass)) {
            ...
            redirect(base_url().'index.php/setting/changePassword?id='.$id);
    ...
    public function updateUser()
    {
        ...
        if (empty($fn)) {
            ...
            redirect(base_url().'index.php/setting/edituser?id='.$id);
        } elseif (empty($email)) {
    ...
    public function updateOutlet()
    {
        ...
        if (empty($outlet_name)) {
            ...
            redirect(base_url().'index.php/setting/editoutlet?id='.$id);
    ...
    public function updateSiteSetting()
    {
        ...
        if (empty($site_name)) {
            ...
            redirect(base_url().'index.php/setting/system_setting');
        } elseif (strlen($tax) == 0) {
