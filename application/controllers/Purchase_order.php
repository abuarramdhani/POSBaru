...
class Purchase_order extends CI_Controller
{
    ...
    public function po_view()
    {
        ...
        $config = array();
        $config['base_url'] = base_url().'index.php/purchase_order/po_view/';
    ...
    public function deletePO()
    {
        ...
        if ($ckExistRows == 1) {
            if ($this->Constant_model->deleteData('purchase_order', $id)) {
                ...
                redirect(base_url().'index.php/purchase_order/po_view');
            }
        }
        unset($ckExistResult);
        unset($ckExistRows);
    ...
    public function ReceiveItemsPO()
    {
        ...
        redirect(base_url().'index.php/purchase_order/receivepo?id='.$id);
    }
    ...
    public function updatePO()
    {
        ...
        if (empty($po_numb)) {
            ...
            redirect(base_url().'index.php/purchase_order/editpo?id='.$id);
        } elseif (empty($outlet)) {
    ...
    public function insertNewPO()
    {
        ...
        if (empty($po_numb)) {
            ...
            redirect(base_url().'index.php/purchase_order/create_purchase_order');
        } elseif (empty($outlet)) {
    ...
    public function deletePOItem()
    {
        ...
        if (count($ckFirstData) == 1) {
            if ($this->Constant_model->deleteData('purchase_order_items', $po_item_id)) {
                ...
                redirect(base_url().'index.php/purchase_order/editpo?id='.$po_id);
            }
        } else {
