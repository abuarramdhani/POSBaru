...
class Pos extends CI_Controller
{
    ...
    public function insertSale()
    {
		...
		<?php
            ...
            redirect(base_url().'index.php/pos/view_invoice?id='.$order_id, 'refresh');
        }
    }
            ...
            */
            ...
            if ($searchRows > 0) {
                ...
                for ($i = 0; $i < count($searchData); ++$i) {
                    ...
                    echo '<a href="'.base_url().'index.php/pos?suspend_id='.$openedBill_id.'" style="text-decoration: none;">
