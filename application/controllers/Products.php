...
class Products extends CI_Controller
{
    ...
    public function product_category()
    {
        ...
        $config = array();
        $config['base_url'] = base_url().'index.php/products/product_category/';
    ...
    public function list_products()
    {
        ...
        $config = array();
        $config['base_url'] = base_url().'index.php/products/list_products/';
    ...
    public function print_label()
    {
        ...
        $config = array();
        $config['base_url'] = base_url().'index.php/products/print_label/';
    ...
    public function updateProduct()
    {
        ...
        if (empty($code)) {
            ...
            redirect(base_url().'index.php/products/editproduct?id='.$id);
        } elseif (empty($name)) {
    ...
    public function updateProductCategory()
    {
        ...
        if (empty($category)) {
            ...
            redirect(base_url().'index.php/products/editproductcategory?id='.$id);
        } else {
            $update_data = array(
                    'name' => $category,
                    'updated_user_id' => $us_id,
